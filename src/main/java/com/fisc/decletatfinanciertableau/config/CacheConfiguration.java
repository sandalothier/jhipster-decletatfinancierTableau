package com.fisc.decletatfinanciertableau.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinancierTableau");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinancierTableau");
        ...
        config.getMapConfigs().put("com.fisc.decletatfinanciertableau.domain.*", initializeDomainMapConfig(jHipsterProperties));
