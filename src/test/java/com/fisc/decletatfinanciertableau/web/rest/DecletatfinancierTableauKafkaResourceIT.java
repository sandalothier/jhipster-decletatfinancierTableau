package com.fisc.decletatfinanciertableau.web.rest;

import com.fisc.decletatfinanciertableau.DecletatfinancierTableauApp;
...
@SpringBootTest(classes = DecletatfinancierTableauApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinancierTableauKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinancierTableauKafkaProducer producer;

    @Autowired
    private DecletatfinancierTableauKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinancierTableauKafkaResource kafkaResource = new DecletatfinancierTableauKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-tableau-kafka/publish?message=test"))
